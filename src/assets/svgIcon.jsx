...
export const IconTakeAwayBag = () => {
  return (
    ...
    >
      <path
        d="M9.33301 9.33333V8.16667C9.33301 6.92899 9.82467 5.742 10.6998 4.86683C11.575 3.99167 12.762 3.5 13.9997 3.5C15.2374 3.5 16.4243 3.99167 17.2995 4.86683C18.1747 5.742 18.6663 6.92899 18.6663 8.16667V9.33333M17.4997 16.3333V14M10.4997 16.3333V14"
        stroke="black"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        d="M4.6665 14.0002C4.6665 11.7998 4.6665 10.7008 5.35017 10.0172C6.03384 9.3335 7.13284 9.3335 9.33317 9.3335H18.6665C20.8668 9.3335 21.9658 9.3335 22.6495 10.0172C23.3332 10.7008 23.3332 11.7998 23.3332 14.0002V15.1668C23.3332 19.5663 23.3332 21.7667 21.9658 23.1328C20.5997 24.5002 18.3993 24.5002 13.9998 24.5002C9.60034 24.5002 7.4 24.5002 6.03384 23.1328C4.6665 21.7667 4.6665 19.5663 4.6665 15.1668V14.0002Z"
        stroke="black"
        strokeWidth="2"
      />
    </svg>
...
export const IconDineInCart = () => {
  return (
    ...
    >
      <path
        d="M5.04571 10.4998H22.954L21.9624 6.99984H6.06655L5.04571 10.4998ZM19.5999 12.8332H8.42905L8.10821 15.1665H19.8915L19.5999 12.8332ZM4.84155 22.0207L6.09571 12.8332H3.49988C3.11099 12.8332 2.80494 12.6776 2.58171 12.3665C2.35849 12.0554 2.2951 11.7151 2.39155 11.3457L4.05405 5.51234C4.13182 5.25956 4.26794 5.05539 4.46238 4.89984C4.65682 4.74428 4.89016 4.6665 5.16238 4.6665H22.8374C23.1096 4.6665 23.3429 4.74428 23.5374 4.89984C23.7318 5.05539 23.8679 5.25956 23.9457 5.51234L25.6082 11.3457C25.7054 11.7151 25.6424 12.0554 25.4192 12.3665C25.196 12.6776 24.8895 12.8332 24.4999 12.8332H21.9332L23.1582 22.0207C23.1971 22.3707 23.1045 22.6771 22.8805 22.94C22.6565 23.2029 22.3699 23.334 22.0207 23.3332C21.729 23.3332 21.4712 23.2406 21.2472 23.0555C21.0232 22.8704 20.8922 22.6324 20.854 22.3415L20.2124 17.4998H7.78738L7.14571 22.3415C7.10682 22.6332 6.97577 22.8716 6.75255 23.0567C6.52932 23.2418 6.27149 23.334 5.97905 23.3332C5.62905 23.3332 5.34244 23.2021 5.11921 22.94C4.89599 22.6779 4.80344 22.3715 4.84155 22.0207Z"
        fill="black"
      />
    </svg>
  );
...
export const IconOrderingModeDisable = () => {
  return (
    <svg
      width="246"
      height="246"
    ...
    >
      ...
      <g mask="url(#mask0_8945_6683)">
        <path
          d="M182.101 65.8389L190.162 42.7894L196.142 51.6487L182.101 65.8389Z"
          fill="#8A8D8E"
        />
        <path
          d="M182.341 68.9324L201.891 54.3017L201.911 64.9905L182.341 68.9324Z"
          fill="#8A8D8E"
        />
        <circle
          cx="122.843"
          cy="122.843"
          r="73.6531"
          transform="rotate(5.90766 122.843 122.843)"
          fill="#8A8D8E"
        />
      </g>
      <g clipPath="url(#clip0_8945_6683)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M127.223 80.4894C103.832 78.0689 82.9067 95.0695 80.4862 118.461C78.0658 141.853 95.0664 162.778 118.458 165.199C141.85 167.619 162.775 150.618 165.195 127.227C167.616 103.835 150.615 82.9099 127.223 80.4894ZM71.0741 117.487C74.0325 88.8974 99.6074 68.1189 128.197 71.0773C156.787 74.0356 177.566 99.6106 174.607 128.201C171.649 156.79 146.074 177.569 117.484 174.611C88.8943 171.652 68.1158 146.077 71.0741 117.487Z"
          fill="white"
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M125.277 99.3122C127.876 99.5811 129.765 101.906 129.496 104.505L127.548 123.329C127.279 125.929 124.954 127.817 122.355 127.549C119.756 127.28 117.867 124.955 118.136 122.356L120.084 103.531C120.353 100.932 122.678 99.0432 125.277 99.3122Z"
          fill="white"
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M116.186 141.182C116.455 138.583 118.78 136.694 121.379 136.963L121.426 136.967C124.026 137.236 125.915 139.561 125.646 142.16C125.377 144.76 123.052 146.648 120.453 146.38L120.405 146.375C117.806 146.106 115.917 143.781 116.186 141.182Z"
          fill="white"
        />
      </g>
      <defs>
        <clipPath id="clip0_8945_6683">
          <rect
            width="113.549"
            height="113.549"
            fill="white"
            transform="translate(72.2124 60.5273) rotate(5.90766)"
          />
        </clipPath>
      </defs>
    </svg>
