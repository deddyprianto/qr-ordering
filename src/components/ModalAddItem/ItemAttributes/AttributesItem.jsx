...
export const RenderAttItem = ({ 
  ...
  return (
    ...
    >
      <div
        className={`items-stretch border flex grow basis-[0%] flex-col px-3.5 py-1 rounded-lg border-solid ${
          att.isSelected?"bg-[#FFF2DF] border-[#00524C]":"bg-white border-[color:var(--Grey-Scale-color-Grey-Scale-3,#D6D6D6)]" 
        }`}
      >
        <div className={`text-gray-700 ${isFromBundle?"text-xs":"text-sm"} font-medium leading-5 tracking-wide`}>
          {att.attributesName}
        </div>
        <div className={`text-gray-700 ${isFromBundle?"text-xs":"text-sm"} font-bold leading-5 tracking-wide mt-2`}>
